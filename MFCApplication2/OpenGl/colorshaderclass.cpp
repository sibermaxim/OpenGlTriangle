...
bool ColorShaderClass::Initialize(COgl* OpenGL, HWND hwnd)
{
	bool result;
...
void ColorShaderClass::Shutdown(COgl* OpenGL)
{
...
void ColorShaderClass::SetShader(COgl* OpenGL)
{
...
bool ColorShaderClass::InitializeShader(char* vsFilename, char* fsFilename, COgl* OpenGL, HWND hwnd)
{
...
void ColorShaderClass::OutputShaderErrorMessage(COgl* OpenGL, HWND hwnd, unsigned int shaderId, char* shaderFilename)
{
	int logSize, i;
	char* infoLog;
	ofstream fout;
...
void ColorShaderClass::OutputLinkerErrorMessage(COgl* OpenGL, HWND hwnd, unsigned int programId)
{
	int logSize, i;
	char* infoLog;
	ofstream fout;
...
void ColorShaderClass::ShutdownShader(COgl* OpenGL)
{
...
bool ColorShaderClass::SetShaderParameters(COgl* OpenGL, float* worldMatrix, float* viewMatrix, float* projectionMatrix)
{
