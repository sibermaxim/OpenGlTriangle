...
// глобальна€ перменна€ дл€ хранени€ ошибки OpenGL
...
public:
	...
	void SetTranslWorldMatrix(glm::mat4 trMatrix);
	void GetTranslWorldMatrix(glm::mat4& trMatrix);
	void SetRotatelWorldMatrix(glm::mat4 rotateMatrix);
